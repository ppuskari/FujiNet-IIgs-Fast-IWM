...
$patchScript = Join-Path $repoRoot 'tools\patch_iwmprobe_p02a3.py'
...
Write-Host 'IWMPROBE P0.2A3 build'
...
$newImage = Join-Path $releaseRoot 'IWMPROBE-P0.2A3.po'
...
Write-Host ''
Write-Host 'IWMPROBE P0.2A3 BUILD COMPLETE' -ForegroundColor Green
